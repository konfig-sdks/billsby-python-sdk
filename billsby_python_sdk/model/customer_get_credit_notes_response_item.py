...
class CustomerGetCreditNotesResponseItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            paymentGatewayDisplayName = schemas.StrSchema
            __annotations__ = {
                "invoiceId": invoiceId,
                "createdOn": createdOn,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["paymentGatewayDisplayName"]) -> MetaOapg.properties.paymentGatewayDisplayName: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["invoiceId", "createdOn", "invoiceNumber", "amount", "currency", "linkedTransactionsCount", "status", "paymentGatewayDisplayName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["paymentGatewayDisplayName"]) -> typing.Union[MetaOapg.properties.paymentGatewayDisplayName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["invoiceId", "createdOn", "invoiceNumber", "amount", "currency", "linkedTransactionsCount", "status", "paymentGatewayDisplayName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        paymentGatewayDisplayName: typing.Union[MetaOapg.properties.paymentGatewayDisplayName, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'CustomerGetCreditNotesResponseItem':
