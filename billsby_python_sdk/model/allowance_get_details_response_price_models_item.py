...
class AllowanceGetDetailsResponsePriceModelsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            includedUnits = schemas.IntSchema
            ...
            @staticmethod
            def tiers() -> typing.Type['AllowanceGetDetailsResponsePriceModelsItemTiers']:
                return AllowanceGetDetailsResponsePriceModelsItemTiers
            __annotations__ = {
                "frequency": frequency,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tiers"]) -> 'AllowanceGetDetailsResponsePriceModelsItemTiers': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["frequency", "frequencyType", "currency", "includedUnits", "flatFeePrice", "flatFeePriceFormatted", "perUnitPrice", "perUnitPriceFormatted", "tiers", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tiers"]) -> typing.Union['AllowanceGetDetailsResponsePriceModelsItemTiers', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["frequency", "frequencyType", "currency", "includedUnits", "flatFeePrice", "flatFeePriceFormatted", "perUnitPrice", "perUnitPriceFormatted", "tiers", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tiers: typing.Union['AllowanceGetDetailsResponsePriceModelsItemTiers', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'AllowanceGetDetailsResponsePriceModelsItem':
