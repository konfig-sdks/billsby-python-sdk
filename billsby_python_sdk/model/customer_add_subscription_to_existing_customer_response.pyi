...
class CustomerAddSubscriptionToExistingCustomerResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customerUniqueId", "subscriptionUniqueId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customerUniqueId", "subscriptionUniqueId", ], str]):
