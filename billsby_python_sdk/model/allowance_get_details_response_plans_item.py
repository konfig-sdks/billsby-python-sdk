...
class AllowanceGetDetailsResponsePlansItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            forceAllowance = schemas.BoolSchema
            isActive = schemas.BoolSchema
            __annotations__ = {
                "planId": planId,
                "planName": planName,
                "productName": productName,
                "forceAllowance": forceAllowance,
                "isActive": isActive,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["forceAllowance"]) -> MetaOapg.properties.forceAllowance: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["planId", "planName", "productName", "forceAllowance", "isActive", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["forceAllowance"]) -> typing.Union[MetaOapg.properties.forceAllowance, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["planId", "planName", "productName", "forceAllowance", "isActive", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        forceAllowance: typing.Union[MetaOapg.properties.forceAllowance, bool, schemas.Unset] = schemas.unset,
    ...
    ) -> 'AllowanceGetDetailsResponsePlansItem':
