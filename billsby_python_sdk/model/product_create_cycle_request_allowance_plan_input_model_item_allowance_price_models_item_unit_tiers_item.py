...
class ProductCreateCycleRequestAllowancePlanInputModelItemAllowancePriceModelsItemUnitTiersItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ProductCreateCycleRequestAllowancePlanInputModelItemAllowancePriceModelsItemUnitTiersItem':
