...
class RequiredInvoiceCreateRefundRequest(TypedDict):
...
class OptionalInvoiceCreateRefundRequest(TypedDict, total=False):
    pass

class InvoiceCreateRefundRequest(RequiredInvoiceCreateRefundRequest, OptionalInvoiceCreateRefundRequest):
    pass
