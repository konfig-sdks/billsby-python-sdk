...
class RequiredCustomFieldCreateNewFieldRequest(TypedDict):
...
class OptionalCustomFieldCreateNewFieldRequest(TypedDict, total=False):
    # A comma separated list of option titles for DropdownField type
    options: str

class CustomFieldCreateNewFieldRequest(RequiredCustomFieldCreateNewFieldRequest, OptionalCustomFieldCreateNewFieldRequest):
    pass
