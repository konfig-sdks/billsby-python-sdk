...
class RequiredProductCreatePlanRequest(TypedDict):
    pass

class OptionalProductCreatePlanRequest(TypedDict, total=False):
...
class ProductCreatePlanRequest(RequiredProductCreatePlanRequest, OptionalProductCreatePlanRequest):
    pass
