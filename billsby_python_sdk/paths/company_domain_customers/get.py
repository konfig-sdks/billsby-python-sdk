...
class BaseApi(api_client.Api):
    ...
    def _list_customers_mapped_args(
        self,
        company_domain: str,
        page: int,
        page_size: int,
    ...
    async def _alist_customers_oapg(
        self,
...
class ListCustomersRaw(BaseApi):
    ...
    async def alist_customers(
        ...
        **kwargs,
        ...
        args = self._list_customers_mapped_args(
            company_domain=company_domain,
            page=page,
            page_size=page_size,
            search=search,
        )
        return await self._alist_customers_oapg(
...
class ListCustomers(BaseApi):
    ...
    async def alist_customers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_customers(
            company_domain=company_domain,
            page=page,
            page_size=page_size,
            search=search,
    ...
    def list_customers(
        ...
        raw_response = self.raw.list_customers(
            company_domain=company_domain,
            page=page,
            page_size=page_size,
            search=search,
