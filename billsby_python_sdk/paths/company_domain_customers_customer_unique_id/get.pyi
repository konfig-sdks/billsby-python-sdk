...
from billsby_python_sdk.model.customer_get_details_response import CustomerGetDetailsResponse as CustomerGetDetailsResponseSchema

from billsby_python_sdk.type.customer_get_details_response import CustomerGetDetailsResponse

from ...api_client import Dictionary
from billsby_python_sdk.pydantic.customer_get_details_response import CustomerGetDetailsResponse as CustomerGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomerGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomerGetDetailsResponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomerGetDetailsResponsePydantic:
        ...
        if validate:
            return CustomerGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomerGetDetailsResponsePydantic, raw_response.body)
