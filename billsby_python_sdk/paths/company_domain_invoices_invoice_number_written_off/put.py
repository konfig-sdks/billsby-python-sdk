...
class BaseApi(api_client.Api):
    ...
    def _mark_written_off_mapped_args(
        self,
        invoice_number: str,
        company_domain: str,
    ...
    async def _amark_written_off_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/invoices/{invoiceNumber}/WrittenOff',
            auth_settings=_auth,
            headers=_headers,
        )
...
class MarkWrittenOffRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_written_off(
        self,
        invoice_number: str,
        company_domain: str,
        **kwargs,
        ...
        args = self._mark_written_off_mapped_args(
            invoice_number=invoice_number,
            company_domain=company_domain,
        )
        return await self._amark_written_off_oapg(
    ...
    def mark_written_off(
        ...
        return self._mark_written_off_oapg(
            path_params=args.path,
        )

class MarkWrittenOff(BaseApi):
    ...
    async def amark_written_off(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amark_written_off(
            invoice_number=invoice_number,
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def mark_written_off(
        ...
        raw_response = self.raw.mark_written_off(
            invoice_number=invoice_number,
            company_domain=company_domain,
        )
        if validate:
