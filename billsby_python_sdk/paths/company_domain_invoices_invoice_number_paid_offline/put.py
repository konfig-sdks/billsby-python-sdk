...
class BaseApi(api_client.Api):
    ...
    def _mark_as_paid_offline_mapped_args(
        self,
        invoice_number: str,
        company_domain: str,
    ...
    async def _amark_as_paid_offline_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/invoices/{invoiceNumber}/PaidOffline',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _mark_as_paid_offline_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class MarkAsPaidOfflineRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_as_paid_offline(
        self,
        invoice_number: str,
        company_domain: str,
        **kwargs,
        ...
        args = self._mark_as_paid_offline_mapped_args(
            invoice_number=invoice_number,
            company_domain=company_domain,
        )
        return await self._amark_as_paid_offline_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def mark_as_paid_offline(
        self,
        invoice_number: str,
        company_domain: str,
    ) -> typing.Union[
        ...
        return self._mark_as_paid_offline_oapg(
            path_params=args.path,
        )

class MarkAsPaidOffline(BaseApi):
    ...
    async def amark_as_paid_offline(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amark_as_paid_offline(
            invoice_number=invoice_number,
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def mark_as_paid_offline(
        ...
        raw_response = self.raw.mark_as_paid_offline(
            invoice_number=invoice_number,
            company_domain=company_domain,
        )
        if validate:
