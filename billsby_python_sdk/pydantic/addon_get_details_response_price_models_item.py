...
from billsby_python_sdk.pydantic.addon_get_details_response_price_models_item_tiers import AddonGetDetailsResponsePriceModelsItemTiers

class AddonGetDetailsResponsePriceModelsItem(BaseModel):
    ...
    tiers: typing.Optional[AddonGetDetailsResponsePriceModelsItemTiers] = Field(None, alias='tiers')
