...
from billsby_python_sdk.pydantic.product_create_new_product_response_product_country_limitation import ProductCreateNewProductResponseProductCountryLimitation

class ProductCreateNewProductResponse(BaseModel):
    description: typing.Optional[str] = Field(None, alias='description')

    product_country_limitation: typing.Optional[ProductCreateNewProductResponseProductCountryLimitation] = Field(None, alias='productCountryLimitation')
