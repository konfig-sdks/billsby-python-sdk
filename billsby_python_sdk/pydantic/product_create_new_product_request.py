...
from billsby_python_sdk.pydantic.product_create_new_product_request_ordered_custom_fields import ProductCreateNewProductRequestOrderedCustomFields
from billsby_python_sdk.pydantic.product_create_new_product_request_product_country_limitation import ProductCreateNewProductRequestProductCountryLimitation

class ProductCreateNewProductRequest(BaseModel):
    ...
    ordered_custom_fields: typing.Optional[ProductCreateNewProductRequestOrderedCustomFields] = Field(None, alias='orderedCustomFields')

    # The type of product you want to create; 1 is tiered
    type_of_product: typing.Optional[int] = Field(None, alias='typeOfProduct')

    product_country_limitation: typing.Optional[ProductCreateNewProductRequestProductCountryLimitation] = Field(None, alias='productCountryLimitation')

    # Do you want to allow any country allowed access to the product; true or false
    is_any_country_allowed: typing.Optional[bool] = Field(None, alias='isAnyCountryAllowed')
