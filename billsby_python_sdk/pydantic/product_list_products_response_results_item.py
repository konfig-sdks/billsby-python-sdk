...
from billsby_python_sdk.pydantic.product_list_products_response_results_item_custom_fields import ProductListProductsResponseResultsItemCustomFields
from billsby_python_sdk.pydantic.product_list_products_response_results_item_ordered_custom_fields import ProductListProductsResponseResultsItemOrderedCustomFields

class ProductListProductsResponseResultsItem(BaseModel):
    ...
    custom_fields: typing.Optional[ProductListProductsResponseResultsItemCustomFields] = Field(None, alias='customFields')

    ordered_custom_fields: typing.Optional[ProductListProductsResponseResultsItemOrderedCustomFields] = Field(None, alias='orderedCustomFields')
