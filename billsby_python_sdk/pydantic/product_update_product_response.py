...
from billsby_python_sdk.pydantic.product_update_product_response_product_country_limitation import ProductUpdateProductResponseProductCountryLimitation

class ProductUpdateProductResponse(BaseModel):
    description: typing.Optional[str] = Field(None, alias='description')

    product_country_limitation: typing.Optional[ProductUpdateProductResponseProductCountryLimitation] = Field(None, alias='productCountryLimitation')
