...
from billsby_python_sdk.exceptions_base import ApiValueError
from billsby_python_sdk.exceptions import ClientConfigurationError
...
conf = billsby_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://public.billsby.com/api/v1/rest/core" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if sec0:
            self.api_key['sec0'] = sec0
        else:
            raise ClientConfigurationError('API Key "sec0" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("billsby_python_sdk")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.3.5\n"\
               "SDK Package Version: 1.3.5".\
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://public.billsby.com/api/v1/rest/core",
